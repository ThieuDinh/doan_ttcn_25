...
namespace doan_ttcn.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        private (decimal subTotal, decimal discount, decimal grandTotal) CalculateTotals(List<CartItemVM> cart, string couponCode)
        {
        ...
        public IActionResult Index()
        {
            ...
            var (subTotal, discount, grandTotal) = CalculateTotals(cart, couponCode);
